...
define("DB_NAME", "web179_3");

/** Database username */
define("DB_USER", "web179_3");

/** Database password */
define("DB_PASSWORD", "DBRqhzMaCkdyBCBoZ");
...
define("BUILDER_EXPIRED", 1717884611);
...
define("BUILDER_DOMAIN", "dlcvietnam.com");
define("BUILDER_HOME", "https://".BUILDER_DOMAIN);
define("PUBLIC_ROOT", __DIR__);

foreach( glob( __DIR__."/builder/includes/*.php") as $file){
