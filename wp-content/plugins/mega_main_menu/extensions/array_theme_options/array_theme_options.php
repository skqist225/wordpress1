				...
				$locations_options = array_merge( 
					$locations_options, array(
						...
						array(
							...
							'descr' => __( 'Check this option to make the menu sticky. Make sure you have disabled "Sticky" in the theme options. Incompatible with the "Vertical" menu. Sticky do not works on mobile devices. If the menu will be sticky on mobile devices when you open it - you will be not able to click on the last item, because it always will be outside the screen.', $constants[ 'MM_TEXTDOMAIN_ADMIN' ] ),
					...
					'options' => array(
						...
						array(
							...
							'values' => array(
								...
								__( 'Linearicons (170)', $constants[ 'MM_TEXTDOMAIN_ADMIN' ] ) => 'linearicons',
							),
							'default' =>  array(
								'icomoon',
							),
						...
						array(
							'name' => __( 'Reset Configuration', $constants[ 'MM_TEXTDOMAIN_ADMIN' ] ),
							'descr' => __( 'If you need to reset configuration of this plugin then check this option and click "Save Changes". <span style="color: #f11;">Warning:</span> After this action all values of options located on this page will be reset to default values.', $constants[ 'MM_TEXTDOMAIN_ADMIN' ] ),
							'key' => 'reset_configuration',
							'type' => 'checkbox',
							'values' => array(
								__( '<span style="color: #f11;">Reset Plugin Configuration</span>', $constants[ 'MM_TEXTDOMAIN_ADMIN' ] ) => 'true',
							),
							'col_width' => 12,
						),
					), // 'options' => array
